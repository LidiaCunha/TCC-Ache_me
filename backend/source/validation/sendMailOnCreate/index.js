...
const sendMailOnCreate = async( req ,res ,next ) => {
    ...
    <div style='width:600px; background-color:#1e1f21; height:500px; margin:0px; padding:20px;'>
        ...
        <a style='text-decoration: none;' href="http://192.168.0.11:3001/validMail/?&name=${name}&mail=${mail}&CPF=${CPF}&telephone=${telephone}&password=${password}&cep=${cep}&bairro=${bairro}&street=${street}&number=${number}&city=${city}&complement=${complement}&state=${state}&photo=${firebaseUrl}">
