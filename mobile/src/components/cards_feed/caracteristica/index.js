      ...
      <View style={styles.container}>
            <View style={styles.contianerCard}>
                ...
                <View style={styles.conteudo}>
                    <TextInput style={styles.input} placeholder="caracteristica" placeholderTextColor="#fff" keyboardType="string"/>
      
                    <ScrollView style={styles.conteudoCaracteristica} horizontal={true}>
                        <View style={[styles.cardCaracteristica, styles.cor1]}>
                            <Text style={styles.textCaracteristica}>cabelo castanho</Text>
