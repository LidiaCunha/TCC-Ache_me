      ...
      >
        <View
          style={[
            styles.cloud,
            {
              backgroundColor: this.props.mine ? '#EDEDED' : '#f37e74'
            }
          ]}
        >
          {
            ...
            ?
              <Image
                style={{ width: 300, height: 300, alignSelf: this.props.mine ? 'flex-start' : 'flex-end' }}
                borderRadius={10}
                marginTop={6}
                marginBottom={6}
          ...
          >
            ...
            >
              <Path
                  ...
                  fill={this.props.mine ? '#EDEDED' : '#f37e74'}
                  x="0"
                  y="0"
              />
            </Svg>
