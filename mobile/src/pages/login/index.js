...
const Login = () => {
    ...
    return (
        <Container source={planoDeFundo}>
            ...
            <Input keyboardType="email-address" id="mail" placeholder="E-mail ou Telefone" value={userLogin.mail} onChange={handleSignIn} required></Input>
            <Input textContentType="newPassword" id="password" placeholder="Senha" value={userLogin.password} onChange={handleSignIn} required></Input>
